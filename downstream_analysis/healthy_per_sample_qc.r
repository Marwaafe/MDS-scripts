#This should be repeated on all the 9 Healthy Bone Marrow samples accordingly ("HealthyBM1", "HealthyBM2" , "HealthyBM3" , "HealthyBM4" , "HealthyBM5" , "HealthyBM6", "HealthyBM7"
...
sample_name <- "HealthyBM9"
data_path<- file.path(
  "/trinity/home/mafechkar/Healthy_BoneM/GSM3396177.h5"
)
